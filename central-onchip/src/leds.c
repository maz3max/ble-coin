...
#define LED0_PORT DT_GPIO_LEDS_LED_0_GPIO_CONTROLLER
#define LED0 DT_GPIO_LEDS_LED_0_GPIO_PIN
#define LED1R_PORT DT_GPIO_LEDS_LED1_RED_GPIO_CONTROLLER
#define LED1R DT_GPIO_LEDS_LED1_RED_GPIO_PIN
#define LED1G_PORT DT_GPIO_LEDS_LED1_GREEN_GPIO_CONTROLLER
#define LED1G DT_GPIO_LEDS_LED1_GREEN_GPIO_PIN
#define LED1B_PORT DT_GPIO_LEDS_LED1_BLUE_GPIO_CONTROLLER
#define LED1B DT_GPIO_LEDS_LED1_BLUE_GPIO_PIN
